...
* [Coding Style](#coding-style)
    * [PHP Code Demarcation](#php-code-demarcation)
    * [Strings](#strings)
        * [String Literals](#string-literals)
        * [String Literals Containing Apostrophes](#string-literals-containing-apostrophes)
        * [Variable Substitution](#variable-substitution)
        * [String Concatenation](#string-concatenation)
        * [Class Names In Strings](#class-names-in-strings)
    * [Arrays](#arrays)
    ...
    * [Functions and Methods](#functions-and-methods)
        * [Function and Method Declaration](#function-and-method-declaration)
        * [Closure Definitions](#closure-definitions)
        * [Function and Method Usage](#function-and-method-usage)
...
> standards or use them as is in accordance with the terms of our [license](http://framework.zend.com/license). 
...
### <a name="Namespace-Aliases"></a>Namespace Aliases 
...
If as a result of such declarations, the line length exceeds the maximum line length, break the line after the `implements` keyword, placing one interface per line, and padding each line by one indentation level: 
...
Concrete exceptions for a component **MUST** live in an `Exception` subnamespace. Concrete exception classes **MUST** implement the component's `ExceptionInterface`, and **SHOULD** extend one of PHP's SPL exception types. Concrete exception classes **SHOULD** be named after the SPL exception type they extend, but **MAY** have a more descriptive name if warranted. 

Subcomponents **MAY** define their own exception marker interface and concrete implementations, following the same rules as at the root component level. The subcomponent exception interface **SHOULD** extend the parent component's `ExceptionInterface`.
...
> } 
> 
> // Here it makes sense, because it could be seen as a bug 
> switch ($foo) { 
>     case 'a': 
>         $baz = 'baz'; 
